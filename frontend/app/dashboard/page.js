...
export default function DashboardPage() {
  ...
  const [useSmartConfig, setUseSmartConfig] = useState(false);
            ...
            <div className="rounded-xl border border-blue-100 bg-blue-50/50 p-4">
              <div className="flex gap-3">
                ...
                <p className="text-sm leading-relaxed text-slate-600">
                  <strong className="text-slate-800">Cap</strong> is the maximum
                  burst of requests.{" "}
                  <strong className="text-slate-800">Rate</strong> is how fast
